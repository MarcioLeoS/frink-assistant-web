  ...
  return (
    <Transition appear show={isOpen}>
      <Dialog as="div" onClose={() => setIsOpen(false)}>
        <TransitionChild
          as="div"
          className="fixed inset-0 bg-zinc-900/30 z-50 transition-opacity"
        ...
        >
          <DialogPanel className="bg-white dark:bg-zinc-800 rounded-lg shadow-lg overflow-auto max-w-lg w-full max-h-full">
            {/* Modal header */}
